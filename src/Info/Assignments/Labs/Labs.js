...
const labs = [
	{
		number: 1, title: "Intellij/Scala Tester Setup Help (Optional)", dueDate: "May 12-13", active: false,
		links: [
	...
	{
		number: 2, title: "Object-Oriented Design", dueDate: "May 19-20", active: false,
		links: [
	...
	{
		number: 3, title: "For-While Loops/Oracle", dueDate: "May 26-27", active: false,
		links: [
	...
	{
		number: 4, title: "Debugging", dueDate: "June 2-3", active: false,
		links: [
	...
	{
		number: 5, title: "File I/O", dueDate: "June 9-10", active: false,
		links: [
	...
	{
		number: 6, title: "Regular Expressions", dueDate: "June 16-17", active: false,
		links: [
	...
	{
		number: 7, title: "Optimization", dueDate: "June 23-24", active: false,
		links: [
	...
	{
		number: 8, title: "Introduction to Scala", dueDate: "June 30-July 1", active: false,
		links: [
	...
	{
		number: 9, title: "Understanding PageRank", dueDate: "July 7-8", active: false,
		links: [
	...
	{
		number: 10, title: "Dynamic Programming", dueDate: "July 14-15", active: false,
		links: [
	...
	{
		number: 11, title: "Understanding Dijkstra's Algorithm", dueDate: "July 21-22", active: false,
		links: [
			{ icon: <FaFileAlt />, link: "https://drive.google.com/file/d/1mLvFgTRgKgD1PPCIY7-PGQzwqwmgbGyF/view?usp=sharing", label: "Handout" },
			{ icon: <FaCode />, link: "https://drive.google.com/drive/folders/11hNP3X9_xtg7kcx8_5VIN13mw1OEvqwa?usp=sharing", label: "Source Code" },
			{ icon: <FaFilePowerpoint />, link: "https://docs.google.com/presentation/d/10j1e7SrPOYDoraIQ9OPZaMo43wYgmJMdZzL3ogp0SqE/edit?usp=sharing", label: "Slides" },
	...
	{
		number: 12, title: "Garbage Collection", dueDate: "July 28-29", active: false,
		links: [
			{ icon: <FaFileAlt />, link: "https://drive.google.com/file/d/1mLvFgTRgKgD1PPCIY7-PGQzwqwmgbGyF/view?usp=sharing", label: "Handout" },
			{ icon: <FaCode />, link: "https://drive.google.com/drive/folders/11hNP3X9_xtg7kcx8_5VIN13mw1OEvqwa?usp=sharing", label: "Source Code" },
			{ icon: <FaFilePowerpoint />, link: "https://docs.google.com/presentation/d/10j1e7SrPOYDoraIQ9OPZaMo43wYgmJMdZzL3ogp0SqE/edit?usp=sharing", label: "Slides" },
